...
public class CreditsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		this.mStarBackground = (StarryBackgroundView) findViewById(R.id.creditsActivity_background);
		
		TextView creditsBlurb = (TextView) findViewById(R.id.creditsActivity_creditsText);
		creditsBlurb.setTypeface(MyApplication.MAIN_FONT);

		ImageButton backButton = (ImageButton) findViewById(R.id.creditsActivity_backButton);
